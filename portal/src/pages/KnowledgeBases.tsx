    ...
    <div>
      ...
      {showCreate && (
        <div className="panel mb-4 border-accent/30">
          <div className="border-b border-border px-5 py-4">
            <h2 className="text-sm font-semibold text-text">Crear knowledge base</h2>
          </div>
      ...
      {loading ? (
        ...
        <div className="panel">
          <EmptyState
            icon={Database}
            title="Sin knowledge bases"
            body="Crea tu primera knowledge base para organizar tus datos."
          />
        </div>
      ) : (
