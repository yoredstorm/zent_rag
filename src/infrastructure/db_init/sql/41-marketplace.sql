-- =============================================================================
-- PROMPT 16 — Marketplace & Sharing (espejo de la migración 037_marketplace.py)
-- =============================================================================
...
CREATE INDEX IF NOT EXISTS idx_marketplace_status ON marketplace_listings(status, category, created_at DESC);
...
('Agente de Soporte', 'support', 'Prompt de soporte al cliente con tono empático y escalamiento.',
...
('Analista de Ventas', 'sales', 'Prompt de análisis de ventas con foco en métricas y recomendaciones.',
...
('Asistente Financiero', 'finance', 'Prompt de finanzas con precisión y advertencias de riesgo.',
...
('Investigador de Mercado', 'research', 'Prompt de investigación con citas a fuentes.',
