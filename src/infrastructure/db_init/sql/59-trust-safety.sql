-- =============================================================================
-- PROMPT 34 — AI Trust & Safety Center (espejo de 053_trust_safety.py)
-- =============================================================================
...
CREATE INDEX IF NOT EXISTS idx_safety_incidents_org_time ON safety_incidents(organization_id, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_safety_incidents_status ON safety_incidents(status, created_at DESC);