-- =============================================================================
-- PROMPT 30 — AI Ops Runbook & Incident Management v2 (espejo de 049)
-- =============================================================================
...
CREATE INDEX IF NOT EXISTS idx_incidents_org_status ON incidents(organization_id, status, detected_at DESC);
