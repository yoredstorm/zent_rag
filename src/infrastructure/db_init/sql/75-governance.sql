-- =============================================================================
-- PROMPT 50 — AI Governance Board & Audit Trail v2 (069)
-- =============================================================================
...
-- Seed de 4 políticas (acceptable_use, deployment, incident_response,
-- data_handling) vía servicio (board._seed_policies) — no en SQL directo.