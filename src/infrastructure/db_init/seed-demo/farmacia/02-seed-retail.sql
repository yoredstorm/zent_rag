...
INSERT INTO farmacia.categories (id, organization_id, name, slug, description, display_order) VALUES
...
INSERT INTO farmacia.categories (id, organization_id, name, slug, description, parent_id, display_order) VALUES
...
INSERT INTO farmacia.suppliers (id, organization_id, name, rut, contact_name, contact_phone, contact_email, website) VALUES
...
INSERT INTO farmacia.health_insurance (id, organization_id, name, code, coverage_percentage) VALUES
...
INSERT INTO farmacia.products (id, organization_id, category_id, supplier_id, name, slug, description, sku, active_ingredient, concentration, presentation_unit, registration_number, requires_prescription, price, cost, tags) VALUES
...
-- =============================================================================
-- 4b. IMÁGENES DE PRODUCTOS
-- =============================================================================
CREATE TABLE IF NOT EXISTS farmacia.product_images (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    organization_id UUID NOT NULL REFERENCES organizations(id) ON DELETE CASCADE,
    product_id UUID NOT NULL REFERENCES farmacia.products(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS farmacia.inventory (
    ...
    updated_at TIMESTAMPTZ DEFAULT NOW(),
    UNIQUE (organization_id, product_id, warehouse_location, batch_number)
);

INSERT INTO farmacia.inventory (organization_id, product_id, warehouse_location, batch_number, expiration_date, quantity_available, quantity_reserved, quantity_minimum, last_restock_date, next_restock_eta_days) VALUES
...
ON CONFLICT (organization_id, product_id, warehouse_location, batch_number) DO NOTHING;
...
INSERT INTO farmacia.customers (organization_id, external_id, rut, name, email, phone, city, region, birth_date, health_insurance_id, loyalty_tier, total_orders, total_spent, created_at) VALUES
...
CREATE TABLE IF NOT EXISTS farmacia.prescriptions (
    ...
    created_at TIMESTAMPTZ DEFAULT NOW(),
    UNIQUE (organization_id, prescription_code)
);

INSERT INTO farmacia.prescriptions (id, organization_id, prescription_code, patient_rut, patient_name, doctor_name, doctor_rut, diagnosis, observations, issue_date, expiration_date) VALUES
...
ON CONFLICT (organization_id, prescription_code) DO NOTHING;
...
INSERT INTO farmacia.sales (organization_id, product_id, customer_id, quantity, unit_price, total_amount, payment_method, payment_amount, health_insurance_id, insurance_covered_amount, prescription_id, sale_date, channel) VALUES
...
INSERT INTO farmacia.product_reviews (organization_id, product_id, customer_id, rating, title, comment, is_verified_purchase, helpful_count) VALUES
...
-- =============================================================================
-- Índices de rendimiento para consultas RAG frecuentes (idempotentes)
-- =============================================================================
CREATE INDEX IF NOT EXISTS idx_sales_organization_date ON farmacia.sales(organization_id, sale_date DESC);
CREATE INDEX IF NOT EXISTS idx_sales_customer_id ON farmacia.sales(customer_id);
CREATE INDEX IF NOT EXISTS idx_customers_external_id ON farmacia.customers(external_id);
