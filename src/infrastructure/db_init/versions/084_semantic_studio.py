"""PHASE 31B — Semantic Mapping Studio (lexicon, field attrs, versions).
...
def downgrade() -> None:
    op.execute("DROP TABLE IF EXISTS catalog_mapping_versions")
    op.execute("DROP TABLE IF EXISTS catalog_abbrev_lexicon")
